...
def main():
    ...
    ops_bedrock_dir = pjoin(monorepo_dir, 'umi2-bedrock')
    contracts_bedrock_dir = pjoin(monorepo_dir, 'packages', 'contracts-bedrock')
    deployment_dir = pjoin(contracts_bedrock_dir, 'deployments', 'devnetL1')
    op_node_dir = pjoin(args.monorepo_dir, 'umi-node')
    ...
    run_command(['docker-compose', 'up', '-d', 'umi-node', 'umi-proposer', 'umi-batcher'], cwd=ops_bedrock_dir, env={
        'PWD': ops_bedrock_dir,

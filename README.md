...
├── <a href="./infra/umi-replica">infra/umi-replica</a>: Deployment examples and resources for running an Optimism replica
...
├── <a href="./umi-exporter">umi-exporter</a>: A prometheus exporter to collect/serve metrics from an Optimism node
...
├── <a href="./umi-bindings">umi-bindings</a>: Go bindings for Bedrock smart contracts.
├── <a href="./umi-batcher">umi-batcher</a>: L2-Batch Submitter, submits bundles of batches to L1
├── <a href="./umi-e2e">umi-e2e</a>: End-to-End testing of all bedrock components in Go
├── <a href="./umi-node">umi-node</a>: rollup consensus-layer client.
├── <a href="./umi-proposer">umi-proposer</a>: L2-Output Submitter, submits proposals to L1
├── <a href="./umi2-bedrock">umi2-bedrock</a>: Bedrock devnet work

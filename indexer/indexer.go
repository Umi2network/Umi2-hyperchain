...
// use of a closure allows the parameters bound to the tumi-level main package,
...
func (b *Indexer) Serve() error {
	...
	b.router.HandleFunc("/v1/airdrumi2/0x{address:[a-fA-F0-9]{40}}", b.airdropService.GetAirdrop)

...
type SystemConfig struct {
	...
	// Overhead identifies the L1 fee overhead, and is passed through opaquely to umi-geth.
	Overhead Bytes32 `json:"overhead"`
	// Scalar identifies the L1 fee scalar, and is passed through opaquely to umi-geth.

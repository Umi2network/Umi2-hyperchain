<template>
  ...
  >
    <defs>
      ...
      >
        <stop offset="0" stumi-color="#e9e9e9" />
        <stop offset="1" stumi-color="#fff" stumi-opacity="0" />
      </linearGradient>
      <linearGradient
        id="c"
        x1=".5"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stop offset="0" stumi-color="#dcdcdc" />
        <stop offset="1" stumi-color="#fff" stumi-opacity="0" />
      </linearGradient>
      <linearGradient
        id="d"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stop offset="0" stumi-color="#f1f1f1" />
        <stop offset="1" stumi-color="#fff" stumi-opacity="0" />
      </linearGradient>
      <linearGradient
        id="e"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stop offset="0" stumi-color="#dedede" />
        <stop offset="1" stumi-color="#fff" stumi-opacity="0" />
      </linearGradient>
      <linearGradient
        id="f"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stop offset="0" stumi-color="#e8e8e8" />
        <stop offset="1" stumi-color="#fff" stumi-opacity="0" />
      </linearGradient>
      <linearGradient
        id="g"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stop offset="0" stumi-color="#fff" />
        <stop offset="1" stumi-color="#f5f5f5" />
      </linearGradient>
      <linearGradient
        id="h"
        x1=".5"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stop offset="0" stumi-color="#c5c5c5" />
        <stop offset="1" stumi-color="#fff" stumi-opacity="0" />
      </linearGradient>
      <linearGradient
        id="i"
        ...
        gradientUnits="objectBoundingBox"
      >
        <stop offset="0" stumi-color="#acacac" />
        <stop offset="1" stumi-color="#f2f2f2" stumi-opacity=".388" />
      </linearGradient>
      <clipPath id="a">

...
import (
	...
	challenger "github.com/ethereum-optimism/optimism/umi-challenger/challenger"
	config "github.com/ethereum-optimism/optimism/umi-challenger/config"
	flags "github.com/ethereum-optimism/optimism/umi-challenger/flags"
	version "github.com/ethereum-optimism/optimism/umi-challenger/version"
...
func run(args []string, action ConfigAction) error {
	...
	app.Name = "umi-challenger"
	app.Usage = "Challenge Invalid L2OutputOracle Outputs"
	app.Description = "A modular umi-stack challenge agent for dispute games written in golang."

...
// Create an alert in umi-genie. The alias will be used an unique identifier for the alert.
...
// Send this with every block. If UMI Genie doesn't get this ping for 10 minutes,
